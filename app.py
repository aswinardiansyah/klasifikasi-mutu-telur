...
def load_image(image_file):
    """Baca gambar dari upload dan ubah ke RGB"""
...
def process_image(image):
    ...
    confidence = model.predict_proba(features_scaled)[0].max() * 100 if hasattr(model, "predict_proba") else 0
...
# STREAMLIT UI
# -----------------------------
st.title("🥚 Deteksi Mutu Telur - Machine Learning")
